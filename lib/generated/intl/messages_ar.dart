...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "onbordingModelBody3": MessageLookupByLibrary.simpleMessage(
      "اكتشف مجموعة واسعة من إعلانات السيارات المصممة خصيصا لتفضيلاتك. تصفح نماذج السيارات المختلفة، وعروض التأجير، والعروض الحصرية من صالات العرض المحلية. مع CarAds",
    ),
