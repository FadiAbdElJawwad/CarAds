...
class _OnbordingScreenState extends State<OnbordingScreen> {
  ...
  Future<void> _completeOnboarding(String role) async {
    ...
    if (mounted) {
      AppRouter.goToAndRemove(screenName: ScreenName.login, arguments: role);
    }
  }
    ...
    return Scaffold(
      body: Column(
        ...
        children: [
              ...
              child: SizedBox(
                ...
                child: PageView.builder(
                  ...
                  itemBuilder: (context, i) {
                    return Image.asset(onboardingData[i].image!);
                  },
                ),
              ),
            ),
          ...
          PrimaryButton(
            text: _currentPage == 2 ? context.loc.userJoin : context.loc.next,
            onPressed: () {
              if (_currentPage == 2) {
          ...
          Visibility(
            ...
            child: PrimaryButton(
              text: context.loc.showroomsJoin,
              onPressed: () => _completeOnboarding('showroom'),
            ),
          ),
          TextButton(
            onPressed: () => _completeOnboarding('user'),
            child: Text(
              context.loc.skip,
